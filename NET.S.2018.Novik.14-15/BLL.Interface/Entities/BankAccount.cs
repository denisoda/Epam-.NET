...
namespace BLL.Interface.Entities
{
    public abstract class BankAccount : IEquatable<BankAccount>
    {
        ...
        private ICalculatorBonusPoints _computeBonusPointsToWithdraw;
        private ICalculatorBonusPoints _computeBonusPointsToDeposit;
        ...
        /// </summary>
        public ICalculatorBonusPoints ComputeBonusPointsToWithdraw
        {
            get
            {
        ...
        /// </summary>
        public ICalculatorBonusPoints ComputeBonusPointsToDeposit
        {
            get
            {
        ...
        /// <summary>
        /// The value to compute bonus points when withdrawing.
        /// </summary>
        public abstract int BonusPointsWithdraw { get; protected set; }

        /// <summary>
        /// The value to compute bonus points when depositing.
        /// </summary>
        public abstract int BonusPointsDeposit { get; protected set; }

        /// <summary>
        /// Type of the <see cref="BankAccount"/>.
        /// </summary>
