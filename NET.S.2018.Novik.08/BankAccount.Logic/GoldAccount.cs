...
namespace BankAccount.Logic
{
    ...
    public class GoldAccount : BankAccount
    {
        ...
        public GoldAccount(int id, string name, decimal balance, int bonusPoint, IComputeBonusPoints computeToWithdraw, IComputeBonusPoints computeToDeposit)
        ...
        public override TypeBankAccount Type { get; protected set; } = TypeBankAccount.Golden;
